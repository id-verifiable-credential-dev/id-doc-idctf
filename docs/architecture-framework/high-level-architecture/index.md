...
<!-- Sumber: Arsitektur Ekosistem Identitas Digital v0.2, §2.3, §3, §7, §9 -->
...
2. [The four Services](the-four-services.md)
3. [The transaction path and the trust path](transaction-path-and-trust-path.md)
